...
namespace SLAP
{
    public class ReadDataFromObject
    {
        ...
        {
            string filePath = @"D:\Scheduling Maintenance\data input\JsonInputTabuSearchAlgorithmServiceTemp.txt";
        ...
        {
            string filePath = @"D:\Scheduling Maintenance\data input\WorksJson.txt";
            StreamReader sr = new StreamReader(filePath);
            string json = sr.ReadToEnd();
            //Console.WriteLine(json);
        ...
        {
            string filePath = @"D:\Scheduling Maintenance\data input\DevicesJson.txt";
            StreamReader sr = new StreamReader(filePath);
            string json = sr.ReadToEnd();
            //Console.WriteLine(json);
        ...
        {
            string filePath = @"D:\Scheduling Maintenance\data input\TechniciansJson.txt";
            StreamReader sr = new StreamReader(filePath);
            string json = sr.ReadToEnd();
            //Console.WriteLine(json);
