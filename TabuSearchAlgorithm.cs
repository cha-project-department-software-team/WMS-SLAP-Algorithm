    ...
    public class TabuSearch
    {
                                         ...
                                         List<Material> listMaterials)
        {
            ...
            foreach (int job in solutionEnough)
            {
                ...
                workInfor = FindPlannedDate.findPlannedDate(workAvailableTable, solutionEnough, job, workInfor,
            ...
            foreach (int job in solutionLack)
            {
                ...
                workInfor = FindPlannedDate.findPlannedDate(workAvailableTable, solutionLack, job, workInfor,
                                                               deviceDictionary, technicianDictionary,
                                                               maintenanceDeviceBreakTime, maintenanceTechnicianWorkTime,
                                                               listwareHouseMaterials, listMaterials,
        ...
        public static DataTable getWorkAvailableTable(DataTable workTable, List<Material> listsparePartAvailable)
        {
                                                         ...
                                                         List<Material> listMaterials)
        {
            ...
            DataTable workAvailableTable = getWorkAvailableTable(workTable, listsparePartAvailable);

            //Find the order of work such that the objective function value is minimal
            List<JobInfor> bestSolution = tabuSearch(workAvailableTable, deviceDictionary, technicianDictionary,
            ...
            //    newRow["No"] = workAvailableTable.Rows[job - 1]["No"];
            //    newRow["Priority"] = workAvailableTable.Rows[job - 1]["Priority"];
            //    newRow["Device"] = workAvailableTable.Rows[job - 1]["Device"];
            //    newRow["Work"] = workAvailableTable.Rows[job - 1]["Work"];
            //    newRow["DueDate"] = workAvailableTable.Rows[job - 1]["DueDate"];
            //    newRow["ExecutionTime"] = workAvailableTable.Rows[job - 1]["ExecutionTime"];
