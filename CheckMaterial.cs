...
namespace SLAP
{
    public class CheckMaterial
    {
        public static List<WareHouseMaterial> getWareHouseMaterial(List<WareHouseMaterialObjectInput> listWareHouseMaterialObjects)
        {
            ...
            //foreach (var part in wareHouseMaterials)
            //{
            //    Console.WriteLine(part.Id.ToString() + " " + part.Code + " " + part.Quantity.ToString() + " " + part.MinimumQuantity.ToString() + " " + part.IsRequestAdd.ToString() + " " + part.ExpectedAddDate.ToString());
            //}
        ...
        public static List<Material> getListWorkEnoughPartId(List<WareHouseMaterial> listWareHouseMaterials, List<Material> listMaterials)
        {
            Dictionary<Material, List<int>> dictJobRemove = findJobRemove(listWareHouseMaterials, listMaterials);
            ...
            int j = 1;
            foreach (Material sparepart in listMaterials)
            {
                sparepart.Id = j++;
            }
