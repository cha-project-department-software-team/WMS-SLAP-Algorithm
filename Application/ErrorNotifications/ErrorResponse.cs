using SLAPScheduling.Application.ErrorNotifications.ErrorDetails;
using SLAPScheduling.Application.Exceptions;

namespace SLAPScheduling.Application.ErrorNotifications
{
    public class ErrorResponse
    {
        ...
        public ErrorResponse(InvalidProductIssueQuantityException ex)
        {
            ...
            Detail = new InvalidProductIssueQuantityErrorDetail(ex.ItemId, ex.Unit, ex.PurchaseOrderNumber, ex.ProductInventoryQuantity, ex.ProductIssueQuantity);
        }
