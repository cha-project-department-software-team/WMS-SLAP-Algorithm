namespace SLAPScheduling.Application.ErrorNotifications.ErrorDetails
{
    public class InvalidProductIssueQuantityErrorDetail
    {
        ...
        public InvalidProductIssueQuantityErrorDetail(string? itemId, string? unit, string? purchaseOrderNumber, double productInventoryQuantity, double productIssueQuantity)
        {
            ItemId = itemId;
            Unit = unit;
