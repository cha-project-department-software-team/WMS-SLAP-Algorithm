namespace SLAPScheduling.Application.DTOs.ReceiptResults
{
    public class LocationRDTO
    {
        ...
        public List<ReceiptSubLotRDTO> ReceiptSubLots { get; set; }

        public LocationRDTO()
        {
        }

        public LocationRDTO(string locationId, List<MaterialSubLotRDTO> materialSubLots, List<ReceiptSubLotRDTO> receiptSubLots)
        {
